...
oarsub -t besteffort -t idempotent -p "dedicated='none' or dedicated = 'serpico' or dedicated = 'linkmedia' or dedicated = 'sirocco' or dedicated = 'intuidoc'" -l /gpu_device=1,walltime=03:00:0 "$SCRIPTDIR/train.sh"
